...
class Season(models.Model):
    ...
    basic_award = models.IntegerField("Antal gange for at tjene basal præmie", default=4, max_length=2)
    basic_award_require_row = models.BooleanField("Gangene skal være registreret i træk for basal præmie", default=True)
    basic_award_require_card = models.BooleanField("Kortet skal være brugt for at tælle for basal præmie", default=False)
    medium_award = models.IntegerField("Antal gange for at tjene medium præmie", default=7, max_length=2)
    medium_award_require_row = models.BooleanField("Gangene skal være registreret i træk for medium præmie", default=True)
    medium_award_require_card = models.BooleanField("Kortet skal være brugt for at tælle for medium præmie", default=True)
    season_award = models.IntegerField("Antal gange for at tjene sæson præmie", default=12, max_length=2)
    season_award_require_row = models.BooleanField("Gangene skal være registreret i træk for sæson præmie", default=False)
    season_award_require_card = models.BooleanField("Kortet skal være brugt for at tælle for sæson præmie", default=False)
